...
import net.ink.scheduler.util.JobLauncherUtil;
 ...
 *
 * @see net.ink.scheduler.core.config.AutowiringSpringBeanJobFactory
 */
@Slf4j
public abstract class AbstractJobConductor extends InkQuartzJob
        implements JobRequestService, InkJobLauncherProvider {
    @Autowired
    ...
    @Override
    public InkJobLauncher getLauncher() {
        return new InkJobLauncher(getJob(), jobLauncher);
    }
