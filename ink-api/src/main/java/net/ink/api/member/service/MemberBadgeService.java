...
import static net.ink.core.core.message.ErrorMessage.MEMBER_CHECK_BADGE_ACCOMPLISHED;
import static net.ink.core.core.message.ErrorMessage.NOT_ACCOMPLISHED_BADGE;
