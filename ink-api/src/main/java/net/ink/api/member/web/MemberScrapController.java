...
import net.ink.api.member.component.MemberScrapMapper;
import net.ink.api.member.dto.MemberScrapDto;
import net.ink.api.member.service.MemberExpressionScrapService;
...
@Api(value = "회원 오늘의 표현 스크랩 엔드포인트", tags = "회원 오늘의 표현 스크랩 엔드포인트")
@RestController
