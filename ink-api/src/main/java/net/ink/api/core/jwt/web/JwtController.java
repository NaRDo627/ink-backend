package net.ink.api.core.jwt.web;
...
public class JwtController {
    ...
    public ResponseEntity<ApiResult<DeprecatedTokenDto>> issue(
        ...
        TokenDto.Ink token = jwtService.issue(profile.getIdentifier());

        return ResponseEntity.ok(ApiResult.ok(
                new DeprecatedTokenDto(token.getInkAccessToken(), token.getInkRefreshToken())
        ));
    }
